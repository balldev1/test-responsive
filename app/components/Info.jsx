...
import { FaFacebook, FaUserAlt, FaTrashAlt, FaCircle } from 'react-icons/fa'
...
const Info = () => {
    ...
    return (
        ...
        <div className='flex flex-col mt-5 ml-5 mr-1'>
                    ...
                    <ul className='flex flex-rows gap-2 '>
                        <div >
                            <li className='bg-white rounded-t-md shadow-t-md mt-1 p-1  shadow-t-md '>
                                <FaCircle className='absolute text-rose-600 left-10' />
            ...
            <div className='flex flex-col  gap-5 border-2 bg-white px-1 py-3 mr-2 rounded-md shadow-md shadow-gray-500 '>
                <div className='flex grid grid-cols-3  gap-2 md:flex md:flex-rows text-sm'>
                    <div className='w-[135px]'>
                        <select class="block md:w-full p-2  rounded-xl border-0 py-1.5 bg-orange-100 text-orange-500 shadow-sm  sm:max-w-xs sm:text-sm sm:leading-6 cursor-pointer w-[100px]">
                    ...
                    <div className='w-[135px] sm:w-[130px]'>
                        <select class="block w-full p-2  rounded-xl border-0 py-1.5 bg-orange-100 text-orange-500 border-none border-orange-200 shadow-sm sm:max-w-xs sm:text-sm sm:leading-6 w-[80px]  cursor-pointer">
                ...
                <div >
                    <div className='md:flex md:flex-row  border-none  p-2 px-1 md:text-sm text-[14px]  rounded-t-md 	' >
                        ...
                        <div className='flex  justify-between flex-row gap-2 cursor-pointer md:ml-auto 2xl:mr-3  md:mt-0 mt-2 md-3'>
                            <button className='border-2 border-none  bg-orange-600 text-white rounded-md md:p-1 md:w-[95px] w-[100px] ' >ยืนยันคำสั่งซื้อ</button>
                            <BsFillChatDotsFill size={23} className='text-blue-500 ' />
                    ...
                    <div class="grid md:grid-cols-12 grid-cols-4 gap-2 text-sm text-black font-bold bg-slate-100 rounded-b-md pb-5">
                        ...
                        <div class="flex flex-row  col-span-2   ">
                            <div className='grid grid-cols-2 '>
                                ...
                                <div className='md:text-sm text-[11px] mb-20'>
                                    Mv 945,me
                                </div>
